...
describe('bot translate heuristic', () => {
  ...
  st.players[0].hand = [{ r:'7', s:'♠' },{ r:'9', s:trump }, { r:'8', s:'♠' }]; // attacker (A) 3 cards
  st.players[1].hand = [{ r:'7', s:'♥' }, { r:'8', s:'♦' }]; // defender (B) 2 cards, 8♦ cannot beat 7♠ if trump not ♦ and suits differ
