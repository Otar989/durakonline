...
- Drag & Drop атаки и защиты, подсветка легальных карт и зон
	- Framer Motion анимации появления / исчезновения карт (FLIP layout)
	- Свайпы на мобильных: вправо = ВЗЯТЬ, влево = БИТО
...
2. Расширенные анимации (перелёт между зонами, стеки бито)
